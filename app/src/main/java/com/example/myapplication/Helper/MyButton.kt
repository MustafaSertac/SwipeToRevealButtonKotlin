...
class MyButton(
    ...
    private val listener: MyButtonOnClickListener
    ...
    fun onDraw(c:Canvas,rectF: RectF,pos:Int){
        ...
        var y=0f
        if(imageResId==0){
            x=cWidth/2f-r.width()/2-r.left.toFloat()
    ...
    private fun drawableToBitmap(d: Drawable?): Bitmap {
        ...
        val bitmap= createBitmap(d!!.intrinsicWidth,d.intrinsicHeight,Bitmap.Config.ARGB_8888)
